...
The `wham.py` script and the example files in `templates/examples/` are taken directly
from that masterclass. All credit for those files belongs to Giovanni Bussi.
